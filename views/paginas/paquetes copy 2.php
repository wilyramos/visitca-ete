...
// Mostrar datos del usuario recomendado
echo '<div style="flex: 1;">';
echo '<h2>Datos del usuario recomendado:</h2>';
echo '<ul>';
echo '<li>Nombre: ' . $usuario_nuevo->nombre . ' ' . $usuario_nuevo->apellido . '</li>';
echo '<li>Email: ' . $usuario_nuevo->email . '</li>';
echo '<li>Preferencias:</li>';
echo '<ul>';
foreach ($preferencia_nueva as $key => $value) {
...
// Mostrar recomendaciones
echo '<div style="flex: 1;">';
echo '<h2>Recomendaciones para el usuario:</h2>';
foreach ($recomendaciones as $actividad_id => list($preferencia, $similitud)) {
    $actividad = $actividades[$actividad_id - 1]; // Obtener la actividad correctamente
    echo '<div class="actividad">';
    echo '<h3>Actividad: ' . $actividad->nombre . '</h3>';
    echo '<p>Descripción: ' . $actividad->descripcion . '</p>';
